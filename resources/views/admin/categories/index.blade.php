        ...
        <tbody>
          @foreach($categories as $category)
              <tr>
                ...
                <a href="{{ route('categories.destroy', $category->id) }}" onclick="return confirm('Esta seguro que desea eliminar el usuario?')"  class="btn btn-danger"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>
              </tr>
          @endforeach
        </tbody>
    </table>
